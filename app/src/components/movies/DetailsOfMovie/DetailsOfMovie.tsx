...
import { Grid, GridCol, Paper, Stack, Group, Title, rem, Badge, ActionIcon, SimpleGrid, Divider, Text, Image } from "@mantine/core";
import { IconHeart, IconClock, IconMovie, IconCalendar } from "@tabler/icons-react";
